...
namespace ZeikomiRetweetWordCloud.Common.Utilities
{
    class PathManager
    {
        ...
        /// <param name="product_name">ProductName</param>
        /// <returns>アプリケーションフォルダパス</returns>
        public static string GetApplicationFolder(string company_name, string product_name)
        {
            var fv = FileVersionInfo.GetVersionInfo(System.Reflection.Assembly.GetEntryAssembly()!.Location);
            return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), company_name, product_name);
        }
        #endregion
